...
BEGIN
  ...
  v_promo_tail :=
    '<p><b>Với gói 1 - 3 - 6 tháng:</b></p>' ||
    '<p>Nhập mã: <b style="font-size:19px">KYTICH207</b> → Giảm <b>20%</b> + tặng thêm <b>7 ngày sử dụng</b></p>' ||
    '<p><b>Với gói 1 tuần:</b></p>' ||
    '<p>Nhập mã: <b style="font-size:19px">KYTICH202</b> → Giảm <b>10%</b> + tặng thêm <b>2 ngày sử dụng</b></p>' ||
  ...
  LOOP
    ...
    PERFORM public.enqueue_email('transactional_emails', jsonb_build_object(
      ...
      'text', 'Uu dai rieng cho ban: nhap ma KYTICH207 (goi 1-3-6 thang) hoac KYTICH202 (goi 1 tuan) tai https://aptiskytich.vn/pricing',
