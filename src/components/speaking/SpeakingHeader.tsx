...
const SpeakingHeader = ({ partLabel, partNumber, totalParts, onExit }: SpeakingHeaderProps) => {
  return (
    <div className="w-full bg-exam-header text-exam-header-foreground px-4 sm:px-6 py-2 sm:py-3 flex items-center justify-between sticky top-0 z-30 shrink-0">
      <div>
