...
export default function SpeakingScratchpad({ outlineB1, outlineB2, currentQuestion, note, onNoteChange, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <textarea
        className={`w-full min-h-0 resize-none border-0 outline-none px-4 py-3 text-sm leading-relaxed text-exam-text placeholder:text-exam-text-muted ${showOutline ? "shrink-0" : "flex-1"}`}
