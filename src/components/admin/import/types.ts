...
export const SKILL_PARTS: Record<Skill, string[]> = {
  ...
  reading: ["Part 1 - Gap Fill", "Part 2 - Text Cohesion", "Part 3 - Gap Fill", "Part 4 - Long Text Comprehension"],
...
export const FULL_EXAM_SHEETS: SheetMapping[] = [
  ...
  { sheetName: "G&V1-25", skill: "grammar_vocab", part: "Part 1 - Grammar", label: "Core Grammar" },
  { sheetName: "G&V26", skill: "grammar_vocab", part: "Vocab Part 1 - Word Synonyms", label: "Vocab Part 1 (Synonyms)" },
  { sheetName: "G&V27", skill: "grammar_vocab", part: "Vocab Part 2 - Sentence Definition", label: "Vocab Part 2 (Definition)" },
  { sheetName: "G&V28", skill: "grammar_vocab", part: "Vocab Part 3 - Definition Matching", label: "Vocab Part 3 (Matching)" },
  { sheetName: "G&V29", skill: "grammar_vocab", part: "Vocab Part 4 - Gap Fill", label: "Vocab Part 4 (Gap Fill)" },
  { sheetName: "G&V30", skill: "grammar_vocab", part: "Vocab Part 5 - Collocation", label: "Vocab Part 5 (Collocation)" },
  // Legacy naming aliases (backward compatible)
